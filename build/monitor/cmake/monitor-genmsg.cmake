...
set(MSG_I_FLAGS "-Imonitor:/home/tuf2/Watcher/src/monitor/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/tuf2/Watcher/src/monitor/msg/box.msg" NAME_WE)
add_custom_target(_monitor_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "monitor" "/home/tuf2/Watcher/src/monitor/msg/box.msg" ""
)

get_filename_component(_filename "/home/tuf2/Watcher/src/monitor/msg/boxes.msg" NAME_WE)
add_custom_target(_monitor_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "monitor" "/home/tuf2/Watcher/src/monitor/msg/boxes.msg" "monitor/box"
)
