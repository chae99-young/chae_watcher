...
if("TRUE" STREQUAL "TRUE")
  set(detect_SOURCE_PREFIX /home/tuf2/chae_watcher/src/detect)
  set(detect_DEVEL_PREFIX /home/tuf2/chae_watcher/devel)
  set(detect_INSTALL_PREFIX "")
  set(detect_PREFIX ${detect_DEVEL_PREFIX})
else()
  set(detect_SOURCE_PREFIX "")
  set(detect_DEVEL_PREFIX "")
  set(detect_INSTALL_PREFIX /home/tuf2/chae_watcher/install)
...
if(NOT "/home/tuf2/chae_watcher/devel/include;/home/tuf2/chae_watcher/src/detect/include " STREQUAL " ")
  set(detect_INCLUDE_DIRS "")
  set(_include_dirs "/home/tuf2/chae_watcher/devel/include;/home/tuf2/chae_watcher/src/detect/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'weilan <weilan@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tuf2/chae_watcher/src/detect/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;std_msgs;sensor_msgs;message_runtime;message_generation")
