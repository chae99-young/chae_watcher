...
(cl:defclass <boxes> (roslisp-msg-protocol:ros-message)
  ((box_num
   ...
   (boxes
    :reader boxes
    :initarg :boxes
    :type (cl:vector watcher_pkg-msg:box)
   :initform (cl:make-array 0 :element-type 'watcher_pkg-msg:box :initial-element (cl:make-instance 'watcher_pkg-msg:box))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <boxes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'boxes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name watcher_pkg-msg:<boxes> is deprecated: use watcher_pkg-msg:boxes instead.")))

(cl:ensure-generic-function 'box_num-val :lambda-list '(m))
(cl:defmethod box_num-val ((m <boxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader watcher_pkg-msg:box_num-val is deprecated.  Use watcher_pkg-msg:box_num instead.")
  (box_num m))

(cl:ensure-generic-function 'boxes-val :lambda-list '(m))
(cl:defmethod boxes-val ((m <boxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader watcher_pkg-msg:boxes-val is deprecated.  Use watcher_pkg-msg:boxes instead.")
  (boxes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <boxes>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'boxes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'watcher_pkg-msg:box))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<boxes>)))
  ...
  (cl:format cl:nil "uint64 box_num~%box[] boxes~%~%================================================================================~%MSG: watcher_pkg/box~%float64 x~%float64 y~%float64 confidence~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'boxes)))
  "Returns full string definition for message of type 'boxes"
  (cl:format cl:nil "uint64 box_num~%box[] boxes~%~%================================================================================~%MSG: watcher_pkg/box~%float64 x~%float64 y~%float64 confidence~%~%~%"))
