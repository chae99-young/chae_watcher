...
(cl:defmethod cl:initialize-instance :after ((m <box>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'box)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name monitor-msg:<box> is deprecated: use monitor-msg:box instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <box>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader monitor-msg:x-val is deprecated.  Use monitor-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <box>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader monitor-msg:y-val is deprecated.  Use monitor-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <box>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader monitor-msg:confidence-val is deprecated.  Use monitor-msg:confidence instead.")
  (confidence m))
